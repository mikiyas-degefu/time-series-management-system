                  ...
                  try {
                    ...
                    $("#button").on("click", "#applyButton", function () {
                      ...
                      let typeYearTable = () => {
                        ...
                        //let indicatorList = data.indicators.filter((item)=>String(item.for_category) === String(selectedCategoryId) && selectedIndictorId.includes(String(item.id)) && item.is_deleted == false)
                        data.indicators.map(
                          ({
                            title_ENG,
                            title_AMH,
                            ...
                            if (String(for_category) === String(selectedCategoryId) && selectedIndictorId.includes(String(id)) && is_deleted == false) {
                              console.log();
                              let title_amharic = "";
                              if (!title_AMH === null)
                                title_amharic = " - " + title_AMH;
